...
public class MainActivityMinuman extends AppCompatActivity implements MakananUtamaInterface{

    RecyclerView mRecyclerview;
    RecyclerView.Adapter mAdapter;
    RecyclerView.LayoutManager mManager;
    RequestQueue mRequest;
    List<ListModelMinuman> mListItem;
    private final String BASE_URL = "https://menu-makanan-andi.herokuapp.com/menuminuman";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new AdapterListMinuman(mListItem,MainActivityMinuman.this, this);
        ...
        JsonObjectRequest requestImage = new JsonObjectRequest(Request.Method.GET, BASE_URL, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray data = response.getJSONArray("menu_minuman");
                    for(int i=0; i<data.length(); i++)
                    {
                        ListModelMinuman model = new ListModelMinuman();
