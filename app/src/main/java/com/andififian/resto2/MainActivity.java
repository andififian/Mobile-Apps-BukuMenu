...
public class MainActivity extends AppCompatActivity implements MakananUtamaInterface{

    RecyclerView mRecyclerview;
    RecyclerView.Adapter mAdapter;
    RecyclerView.LayoutManager mManager;
    RequestQueue mRequest;
    List<ListModel> mListItem;

    private final String BASE_URL = "https://menu-makanan-andi.herokuapp.com/menumakananutama";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new AdapterList(mListItem,MainActivity.this, this);
