...
public class ListModel {
    ...
    public ListModel(){};
    public ListModel(String id, String menu_makanan, String harga, String gambar_makanan, String nama_makanan, String desc_makanan) {
        this.id = id;
    ...
    public void setNama_makanan(String id) {
        this.nama_makanan = nama_makanan;
    }
