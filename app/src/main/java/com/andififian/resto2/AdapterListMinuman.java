...
public class AdapterListMinuman extends RecyclerView.Adapter<AdapterListMinuman.HolderItem> {
    List<ListModelMinuman> mListItem;
    Context context;
    private final MakananUtamaInterface makananutamainterface;


    public AdapterListMinuman(List<ListModelMinuman> mListItem, Context context, MakananUtamaInterface makananutamainterface) {
    ...
    public void onBindViewHolder(@NonNull HolderItem holder, int position) {
        ListModelMinuman mlist = mListItem.get(position);
